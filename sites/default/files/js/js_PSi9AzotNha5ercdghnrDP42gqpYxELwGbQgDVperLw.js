...
(function estockdata() {
	$.ajax({
		...
		success: function(data) {
			...
			var timestampval = substr[1];
			var estock = substr1[1];
			var timeval = timestampval.replace(/['"]+/g, '');
			$('#last_val').html(estock);
			$('#time_val').html(timestampval);
		},
		complete: function() {
...
(function weather_data() {
	$.get('cronjobs/weather_info.php', function(data) {
		setTimeout(weather_data, 60 * 60 * 1000);
	});
})();;
/**
* DO NOT EDIT THIS FILE.
