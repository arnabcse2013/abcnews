...
namespace Drupal\data_permissions\Controller;

use Drupal\Core\Controller\ControllerBase;

/**
 * Controller for our data page route.
 */
class DataPermissionsPageController extends ControllerBase {
  ...
  public function overviewPage() {
    ...
    $level1_access = \Drupal::currentUser()->hasPermission('data permission 1');
    $level2_access = \Drupal::currentUser()->hasPermission('data permission 2');
    $level3_access = \Drupal::currentUser()->hasPermission('data permission 3');
